...
const TeacherDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Calculate consistent average score
        ...
        if (quizzesData.length > 0) {
          // Sort quizzes by created_at date (newest first)
  ...
  // Only show quiz score data if there are quizzes available
  ...
  // Determine if needs improvement based on avg score
